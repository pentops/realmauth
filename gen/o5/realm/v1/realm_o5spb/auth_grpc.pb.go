...
const (
	AuthService_Whoami_FullMethodName = "/o5.realm.v1.service.AuthService/Whoami"
)
...
func (c *authServiceClient) Whoami(ctx context.Context, in *WhoamiRequest, opts ...grpc.CallOption) (*WhoamiResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthService_Whoami_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "o5.realm.v1.service.AuthService",
	...
	Metadata: "o5/realm/v1/service/auth.proto",
}
